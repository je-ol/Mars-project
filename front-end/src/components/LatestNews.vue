    ...
    <div class="flex w-[100%] h-[26rem] ml-[4rem] my-[12rem]">
        ...
        <div class="w-[2px] h-full bg-white/80 mx-4 "></div>
            <div class="flex justify-evenly items-end h-[100%] w-[100%]">
                <div class="h-[86%] w-[20%] bg-white/95 shadow-lg rounded-sm"
...
import { onMounted, ref } from 'vue';
    ...
    const fetchNews = async () => {
        try {
            const response = await axios.get('https://api.thenewsapi.com/v1/news/all?api_token=FxWVDl0pL3HYyTv3uTavGSv08uYKG5OU07zRJwZZ&search=mars+nasa&language=en&exclude_domains=app.buzzsumo.com,ecns.cn', {
